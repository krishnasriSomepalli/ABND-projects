        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonString != null) {
                try {
                    ...
                    JSONArray pokemons = root.optJSONArray("pokemon");

                    // looping through all Contacts
                    for (int i = 0; i < pokemons.length(); i++) {
                        JSONObject thisPokemon = pokemons.optJSONObject(i);
                        String name = thisPokemon.getString("name");
                        int id = thisPokemon.getInt("id");
                        String candy = thisPokemon.getString("candy");
                        ...
                        pokemon.put("id", Integer.toString(id));
